...
#define TRANSLATION_MIN_WAITING_TIME 250
#define TRANSLATION_MAX_WAITING_TIME 1000

#define ROTATION_MIN_WAITING_TIME 250
#define ROTATION_MAX_WAITING_TIME 1000
